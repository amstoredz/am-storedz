    ...
    <div className="min-h-screen flex flex-col bg-[#fdfdfd]">
      ...
      <section className="py-20 bg-white border-b">
        <div className="container mx-auto px-4">
          <div className="flex gap-6 overflow-x-auto no-scrollbar md:grid md:grid-cols-3 md:gap-12">
            <div className="flex flex-col items-center text-center group shrink-0 md:shrink">
      ...
      <section id="products" className="py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          {displayedProducts.length > 0 ? (
            <div className="flex gap-6 overflow-x-auto no-scrollbar md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-10">
              {displayedProducts.map((product) => (
                <div
                  key={product.id}
                  className="bg-white rounded-[2.5rem] overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 group cursor-pointer border border-transparent hover:border-gold-100 min-w-[260px] md:min-w-0"
